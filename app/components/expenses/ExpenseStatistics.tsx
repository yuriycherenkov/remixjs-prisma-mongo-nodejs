...
import type { IExpensesList, IExpenses } from './interfaces';

function calculateSummaryStatistics(expenses: IExpenses[]) {
...
function ExpenseStatistics({ expenses }: IExpensesList) {
